...
- Сохранение HTML в файл `data/knowledge.html`
...
- Архитектура: независимый процесс, работает с локальными файлами, не зависит от источника контента
...
- /help
- Текстовые запросы
- Админские команды (import_content, load_model, vectorize)
