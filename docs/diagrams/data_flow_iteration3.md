...
**Ревью (итерация 15):** Актуально для запуска и конфигурации. Уточнения: проверка доступа сейчас по **чату** (`chats.allowed`), не по пользователю; маршрутизация на /help, /search, /admin вынесена в `docs/diagrams/command_routing.md`.
